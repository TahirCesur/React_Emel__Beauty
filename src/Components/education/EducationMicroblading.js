...
import { useTranslation } from "react-i18next"; // i18n ekledik

function EducationMicroblading() {
  const { t } = useTranslation(); // Çeviri fonksiyonunu tanımladık
    ...
    <section id="departments" className="departments">
      <div className="container">
        <div className="section-title">
          <h2>{t("EĞİTİMLERİMİZ")}</h2> {/* Metni çevirin */}
        </div>
        ...
        <div className="row gy-4">
            ...
            <ul className="nav nav-tabs flex-column">
              ...
              <li className="nav-item">
                <Link
                  ...
                  onClick={scrollToTop}
                >
                  {t("Kalıcı Dudak Renklendirme Eğitimi")} {/* Metni çevirin */}
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  ...
                  onClick={scrollToTop}
                >
                  {t("Kaş Silme Eğitimi")} {/* Metni çevirin */}
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  ...
                  onClick={scrollToTop}
                >
                  {t("Kaş - Kirpik Lifting Eğitimi")} {/* Metni çevirin */}
                </Link>
              </li>
            </ul>
          </div>
          <div className="col-lg-9">
            <div className="tab-content">
                  ...
                  <div className="col-lg-8 details order-2 order-lg-1">
                    ...
                    <ul className="departmentsegitim">
                      <li>
                        ...
                        {t("Cilt Anatomisi")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Pigment Bilgisi")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Altın Oran Tasarım")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Lateks Çalışması")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Cihaz ve İğne Bilgisi")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Canlı Model Uygulaması")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Eğitim Sonrası Destek")} {/* Metni çevirin */}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Sertifika")} {/* Metni çevirin */}
                      </li>
                    </ul>
                  </div>
              ...
              {/* Diğer tabları da aynı şekilde çevirin */}
                ...
                <div className="row gy-4">
                  <div className="col-lg-8 details order-2 order-lg-1">
                    ...
                    <ul className="departmentsegitim">
                      ...
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Adım Adım İşlem Uygulaması")}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Sonrası Bakım Aşamaları")}
                      </li>
                      <li>
                        <i className="ri-check-double-line"></i>
                        {t("Canlı Model Uygulaması")}
...
export default EducationMicroblading;
