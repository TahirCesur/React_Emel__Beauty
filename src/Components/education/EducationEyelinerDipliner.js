...
import { useTranslation } from "react-i18next"; // i18next'ten çeviri fonksiyonunu almak için import edin

function EducationEyelinerDipliner() {
  const { t } = useTranslation(); // Çeviri fonksiyonunu kullanmak için useTranslation() hook'unu kullanın
    ...
    <section id="departments" className="departments">
      <div className="container">
        <div className="section-title">
          <h2>{t("EĞİTİMLERİMİZ")}</h2> {/* Başlığı çevirin */}
        </div>
...
export default EducationEyelinerDipliner;
